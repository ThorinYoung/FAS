...
def main():
    ...
    # 在这儿选择生成器
    tflib.init_tf()
    with open('../checkpoint/generator_yellow-stylegan2-config-f.pkl', "rb") as f:
    ...
    face_latent = read_feature('res/generate_codes/0000.txt')
    ...
    print(w)
    # here changed
    w = np.load('../s2e/latent_representations/20151202220919_NL5B4_01.npy')
    ...
    direction_file = 'beauty.npy'  # 从上面的编辑向量中选择一个
